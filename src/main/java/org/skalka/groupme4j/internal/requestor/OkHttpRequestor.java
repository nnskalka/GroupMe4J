...
public class OkHttpRequestor implements HttpRequestor {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(OkHttpRequestor.class);
  ...
  public String post(String url, Map<String, Object> headers, String body) {
    RequestBody postBody = RequestBody.create(MediaType.parse("application/json; charset=utf-8"),
        body);
