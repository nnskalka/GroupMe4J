...
public enum EventType {
  ...
  public static final String CALENDAR_CANCELLED = "calendar.event.cancelled";
  ...
  public static final  String POLL_ENDED = "poll.finished";
  public static final  String POLL_REMINDER = "poll.reminder";
